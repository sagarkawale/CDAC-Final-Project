        ...
        <section className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-2 px-4 pt-10">
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl  lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className=" space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
...
<div className='flex items-center mt-1'>
          <span className='text-[26px] font-medium text-red-600'>₹&nbsp;{100}</span>
          <span>&nbsp;({75}% Off)</span>
        </div>
...
onSelect={() => handleSelectProgress(50)}
selected={selectedProgress === 50}> </ProgressBar>    
       ...
       <div className='flex items-center mt-1'>
          <span className='text-[26px] font-medium text-red-600'>₹&nbsp;{500}</span>
          <span>&nbsp;({50}% Off)</span>
        </div>
        <span className='text-blue-500'>Delivery&nbsp;</span><span>within Two Days.</span>
       ...
       <div className='flex items-center mt-1'>
          <span className='text-[26px] font-medium text-red-600'>₹&nbsp;{1500}</span>
          <span>&nbsp;({25}% Off)</span>
        </div>
        <span className='text-blue-500'>Delivery&nbsp;</span><span>within Two Days.</span>
       ...
       <ProgressBar progress={50}
          onSelect={() => handleSelectProgress(50)}
          onClick={selectedProgress === 50}> </ProgressBar>
              </div>
<br></br>
              {/* Reviews */}
              <div className="mt-6">
